...
<body>
	...
	<form class="form-horizontal" action="tranServlet" id="saveForm" role="form" style="position: relative; top: -30px;">

		<input type="hidden" name="action" value="createTran">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="7b3ab760f6a54809bccf1714e3dfa062"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="e022f1d0204f447fa9fa14003b6d9efc"/>
