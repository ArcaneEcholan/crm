...
<script type="text/javascript">
	...
	$(function(){
	    ...
	    $("#updateRemarkBtn").click(function () {
	        ...
	        $.getJSON("activityServlet",{
                ...
                if(data.success) {
                    ...
                    var small = data.activityRemark.createTime + " 由 " + data.activityRemark.createBy;
                    $("#s" + id).html(small);
	    ...
	    $("#remarkSaveBtn").click(function (){
            ...
            var activityId = '${requestScope.a.id}';
            ...
            $.getJSON("activityServlet", {
                ...
                if(data.success){
                    ...
                    html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${requestScope.a.name}</b> <small id ="s' + n.id + '" style="color: gray;">' + (data.activityRemark.createTime) + '由' +(data.activityRemark.createBy)+ '</small>';
                    html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                    html += '<a class="myHref" onclick="editRemark(\'' +data.activityRemark.id+ '\')" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #ff0000;"></span></a>';
    ...
    function showRemark () {
        $.getJSON("activityServlet", {
            ...
            $.each(data,function (i,n) {
                ...
                html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${requestScope.a.name}</b> <small id ="s' + n.id + '" style="color: gray;">' + (n.editFlag == 1 ? n.editTime : n.createTime) + '由' +(n.editFlag == 1 ? n.editBy : n.createBy)+ '</small>';
                html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
